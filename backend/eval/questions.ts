...
export const QUESTIONS: EvalQuestion[] = [
...

  {
    ...
    keyFacts: [
      ...
      "Add a small scoop of pumpkin puree mixed in with dinner",
      "The pumpkin is canned, in the fridge, NOT pie filling",
    ],
    antiHallucinations: [
      "Luna eats wet food",
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "She pulls a little at first but settles down",
      "Use the red leash on the hook by the front door",
    ],
    sourceDoc: "Pets",
  },
  {
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "Let her come sit with you",
      "She'll tremble but just wants to be near someone",
    ],
    sourceDoc: "Pets",
  },
  {
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "She thinks it's a treat so it's easy",
...

  {
    ...
    keyFacts: [
      ...
      "1/4 cup dry food (Purina, second shelf in pantry)",
      "One small can of wet food (Fancy Feast variety pack)",
      "Food and water on the counter in the laundry room, up high so Luna can't eat it",
      "She's a grazer, won't finish wet food right away",
    ],
    sourceDoc: "Pets",
  },
  {
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "She'll hide for the first day or two",
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "One chapter or 15 minutes of reading",
      "Night light stays on by the door",
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "Bath every other night (she keeps track)",
      "Brush teeth — she needs help",
      "2 stories",
      "Twinkle Twinkle song",
      "Sound machine on — the Hatch, press the button once",
      "She needs her stuffed elephant Ellie — check couch cushions if missing",
    ],
    antiHallucinations: [
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "She doesn't have her own device",
    ],
    antiHallucinations: [
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "He'll come out on his own, just be visible",
      "Abernethy Elementary, 2421 SE Orange St",
    ],
    sourceDoc: "Kids - Routines and Rules",
  },
  {
    ...
    keyFacts: [
      ...
      "Sign her in on the clipboard",
      "Tell her teacher Ms. Adriana if someone different is picking up",
      "They check IDs if they don't recognize you",
    ],
    sourceDoc: "Kids - Routines and Rules",
  },
  {
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "He needs a water bottle",
      "Fridays he has no activities",
    ],
    sourceDoc: "Kids - Routines and Rules",
  },
...

  {
    ...
    keyFacts: [
      "Network: CastilloPark-5G",
      "Password: sunflower2024",
      "There's also a 2.4GHz network with the same password",
    ],
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "When you turn on the TV via Roku, audio automatically routes through the Arc",
      "You don't need to do anything in the Sonos app for TV audio",
      "The living room also responds to the TV remote volume",
    ],
    sourceDoc: "House Operations",
  },
  {
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "There's also an All Off scene for when leaving the house",
    ],
    sourceDoc: "House Operations",
  },
  {
    ...
    keyFacts: [
      "Garbage (gray bin): Tuesday mornings, put out Monday night",
      "Recycling (blue bin): every other Tuesday — calendar on the fridge",
      "Compost (green bin): Tuesday with garbage",
      "Bins are on the side of the house by the gate",
      "The gate latch sticks — lift up while pushing the handle down",
    ],
    sourceDoc: "House Operations",
  },
  {
...

  {
    ...
    keyFacts: [
      ...
      "Green craftsman with the big maple tree out front",
    ],
    sourceDoc: "Emergency and General Info",
  },
  {
    ...
    keyFacts: [
      "Passcode is 0000",
      "It should stay unlocked most of the time",
      "Don't move it — it's always plugged in",
    ],
    sourceDoc: "House Operations",
  },
  ...
  },
  {
    ...
    keyFacts: [
      ...
      "Uses clumping litter in the bucket under the utility sink",
      "Refill about 3 inches deep",
    ],
    sourceDoc: "Pets",
  },
  {
